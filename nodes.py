...
from .omnix.model_loader import OmniXModelLoader as ModelLoader, OmniXConfig
from .omnix.generator import (
    OmniXPanoramaGenerator as PanoramaGenerator,
    GenerationConfig,
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "OmniXModelLoader": OmniXModelLoader,
    "OmniXPanoramaGenerator": OmniXPanoramaGenerator,
